...
<a href="/"><img src="https://mercode.org/hub.mercode.png" alt="hub.mercode.org"></a>
...
<li class="nav-item" id="membermen">
...
<a class="dropdown-item" href="/" title="{{t('Home')}}">
<i class="fa fa-fw fa-star generic-icons-nav"></i>
{{t('Home')}}
</a>
{{if $nav.login && !$userinfo}}
{{if $nav.loginmenu.1.4}}
<a class="dropdown-item" href="#" title="{{$nav.loginmenu.1.3}}" id="{{$nav.loginmenu.1.4}}" data-toggle="modal" data-target="#nav-login">
<i class="fa fa-fw fa-user generic-icons-nav"></i>
{{$nav.loginmenu.1.1}}
</a>
{{else}}
...
{{/if}}
{{if $nav.alogout}}
<a class="dropdown-item" href="{{$nav.alogout.0}}" title="{{$nav.alogout.3}}" id="{{$nav.alogout.4}}">
<i class="fa fa-fw fa-user generic-icons-nav"></i>
{{$nav.alogout.1}}
</a>
{{/if}}
...
<div class="dropdown-header"></div>
<a class="nav-link" href="/" title="{{t('Home')}}">
<i class="fa fa-fw fa-star generic-icons-nav"></i>
{{t('Home')}}
</a>
{{if $nav.login && !$userinfo}}
...
{{/if}}
{{if $nav.alogout}}
<a class="nav-link" href="{{$nav.alogout.0}}" title="{{$nav.alogout.3}}" id="{{$nav.alogout.4}}">
<i class="fa fa-fw fa-user generic-icons-nav"></i>
{{$nav.alogout.1}}
</a>
{{/if}}
